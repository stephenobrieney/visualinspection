...
class ImageSelector(object):
    ...
    def select_best_frames(self, input_key_frames, img_idx):
    # def select_best_frames(self, input_key_frames, number_of_frames):
        ...
        :param img_idx: corresponding list of keyframe indices in original video
        ...
        filtered_images_list_idx = []
        # Selecting only those images which have good brightness and contrast
        ...
        if len(input_key_frames) >= 1:
            ...
            for index in selected_images_index:
                ...
                filtered_images_list_idx.append(img_idx[index])
        else:
            # if the input candidate frames are less than a single cluster.
            for img in input_key_frames:
                filtered_images_list.append(img)
            filtered_images_list_idx.extend(img_idx)

        return filtered_images_list, filtered_images_list_idx
